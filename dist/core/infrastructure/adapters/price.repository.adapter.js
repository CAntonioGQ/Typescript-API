...
class PriceAdapterRepository {
    ...
    remove(id, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const productRepository = new product_repository_adapter_1.ProductAdapterRepository();
            const products = yield productRepository.list();
            const relatedProducts = products.filter(product => Number(product === null || product === void 0 ? void 0 : product.price) === price.idPrice);
